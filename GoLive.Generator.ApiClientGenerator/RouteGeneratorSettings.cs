...
namespace GoLive.Generator.ApiClientGenerator
{
    public class RouteGeneratorSettings
    {
        ...
        public string ResponseWrapperType { get; set; } = "Response";
        ...
        public bool GenerateServerImplementation { get; set; }
        public string? ServerImplementationNamespace { get; set; }
        public HashSet<string>? ServerImplementationTransformParameterTypes { get; set; }
    }
}